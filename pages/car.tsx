      ...
      <div className="pt-6">
        ...
        <div className="mx-auto max-w-2xl px-4 pb-16 pt-10 sm:px-6 lg:grid lg:max-w-7xl lg:grid-cols-3 lg:grid-rows-[auto,auto,1fr] lg:gap-x-8 lg:px-8 lg:pb-24 lg:pt-16">
          ...
          <div className="mt-4 lg:row-span-3 lg:mt-0">
            ...
            <p className="text-3xl tracking-tight text-gray-900">AED 2000000</p>
            ...
            <div className="mt-10">
              ...
              <div className="mt-4">
                <ul role="list" className="list-none space-y-2 text-sm">
                  ...
                  <li className="text-gray-400">
                    <span className="text-gray-600">
                      PRICE: <span className="text-black">2023</span>
                    </span>
                  </li>
                  <li className="text-gray-400">
                    <span className="text-gray-600">
                      GAS: <span className="text-black">Petrol</span>
                    </span>
                  </li>
                  <li className="text-gray-400">
                    <span className="text-gray-600">
                      LOCATION: <span className="text-black">Dubai</span>
                    </span>
                  </li>
                  <li className="text-gray-400">
                    <span className="text-gray-600">
                  ...
                  <li className="text-gray-400">
                    <span className="text-gray-600">
                      CONDITION: <span className="text-black">80%</span>
                    </span>
                  </li>
                </ul>
              </div>
